...
<script id="itemTemplate" type="text/template">
    <div class="itemTitre item<%= id %>"  data-id="<%= id %>" style="position:absolute;left:<%= left %>px;top:<%= top %>px">
        <a href="#"><img src='front/dring13/persoRouge.png' alt='<%= title %>' /></a>
    </div>
</script>
        ...
        <div class="uploadBody">		
            ...
            <div id="etape_vote" class="etape_vote" style="display:none">
                ...
                <div class="inputs">
                    <div class="sliders">
                        <div class="elementForm">
                            <span class="sliderLabel"><%= gauche %></span><input type="range" id="uploadSliderIc" min="0" max="100" value="50" /><span><%= droite %></span>
                        </div>
                        <div class="elementForm">
                            <span class="sliderLabel"><%= bas %></span><input type="range" id="uploadSliderRu" min="0" max="100" value="50" /><span><%= haut %></span>
                        </div>
                    </div>
                </div>
                <div class="buttonParent">
