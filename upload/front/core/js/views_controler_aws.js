...
var AppView = Backbone.View.extend({
	...
	connectToWebServicesForUpload: function () {
		...
		// ... déclenchera le téléchargement de la liste des projets
		v.on("authentificationSuccess", this.fetchProjectsForUpload, this);
	},
	...
	fetchProjectsForUpload: function() {
		...
		var success = function(jsonResult) {
			...
			jsonResult = _(jsonResult).filter(function (query) {
					return query.content && (query.content.indexOf(t.queriesPrefix) == 0) && (query._isValid === "1");
			});
			
			App.Collections.queries = new QueriesCollection(jsonResult);
			
			console.log(App.Collections.queries);
