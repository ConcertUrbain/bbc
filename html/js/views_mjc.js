...
var MJCAppView = AppView.extend({
	...
	initialize: function () {
		...
		this.keyApi = "BBC_qJlCaSsBbYBYypwF9TT8KmCOxhuZ";
	...
	displayUploadKeyWordSelectionView: function() {
		...
		var type1KeyWords = App.Collections.Type1KeyWord;
		var type2KeyWords = App.Collections.Type2KeyWord;
		var type3KeyWords = App.Collections.Type3KeyWord;
		
		type1KeyWords.each( function( metaModel ) {
			metaModel.set("typeMotCle", 1);
			metas.add( metaModel );
		});
		
		type2KeyWords.each( function( metaModel ) {
			metaModel.set("typeMotCle", 2);
			metas.add( metaModel );
		});
		
		type3KeyWords.each( function( metaModel ) {
	...
	initUploadKeywordSelect: function( queryKeyWordCollection ) {
		...
		$(".keyword", keywordsParent).on("click", function() {
