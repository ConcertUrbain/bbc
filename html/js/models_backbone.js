...
var ItemModel = Backbone.Model.extend({
	...
	computeRateFromVotes: function(canvasWidth, canvasHeight)
	{
		...
		votesCollection.each(function(dataModel) {
			...
			positionVotes.push({ x: t.getXFromIndividuelCollectif(ic / 255.0, canvasWidth), y: t.getYFromRealisteUtopique(ru / 255.0, canvasHeight) });
			...
			positionAverageVotes.push({ x: t.getXFromIndividuelCollectif(moy_ic / 255.0, canvasWidth), y: t.getYFromRealisteUtopique(moy_ru / 255.0, canvasHeight) });
	...
	getYFromRealisteUtopique: function(ru, canvasHeight)
	{
		var marginTop = 20;
		var marginBottom = 80;
		var imageHeight = 100; // HAUTEUR du CANVAS
